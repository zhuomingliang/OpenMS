...
var monster = Array(9400300,8840000,9400409,1,8820001,0, 2);
...
modified.setOMp(mob.getMobMaxMp());
	...
	case 8840000:
	    ...
	    modified.setOHp(mob.getMobMaxHp() * 8); //goes stack overflow over 1.6b if too high
	    break;
	case 9400589:
	case 9400590:
	case 9400591:
...
function allMonstersDead(eim) {
	...
	eim.saveBossQuest(25000);
	eim.saveNX(120000);
	eim.broadcastPlayerMsg(5, "Your team've beaten the HELL mode and have gained an extra 25,000 points and extra 60,000 Cash!");
